...
![总览](preview/preview-01.png)

形象由文件名扫描发现，丢图进去就能切换 —— **同一套界面，换个人就是另一种气质**：

| 形象 2 · 黑裙（切换后） | 形象切换控件与人物特写 |
|:--:|:--:|
| ![形象 2](preview/preview-02.png) | ![形象切换](preview/preview-03.jpg) |

> 三张截图取自一个**没有会话记录的干净实例**：侧栏只有 DSH 品牌位与「暂无会话」，**不含任何个人数据**。
